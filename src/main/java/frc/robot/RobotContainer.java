...
import frc.robot.commands.Cannons.FifthCannon;
import frc.robot.commands.Cannons.FirstCannon;
import frc.robot.commands.Cannons.FourthCannon;
import frc.robot.commands.Cannons.SecondCannon;
import frc.robot.commands.Cannons.SixthCannon;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    JoystickButton dc_rShoulder = new JoystickButton(m_driverController, XboxController.Button.kRightBumper.value);
    JoystickButton dc_lShoulder = new JoystickButton(m_driverController, XboxController.Button.kLeftBumper.value);

    dc_aButton.whileHeld(new FirstCannon(m_airSubsystem)); 
    dc_yButton.whenPressed(new CompressorControl(m_airSubsystem));
    // dc_bButton.whileHeld(new SecondCannon(m_airSubsystem));
    // dc_xButton.whileHeld(new ThirdCannon(m_airSubsystem));
    // dc_yButton.whileHeld(new FourthCannon(m_airSubsystem));
    // dc_lShoulder.whileHeld(new FifthCannon(m_airSubsystem));
    // dc_rShoulder.whileHeld(new SixthCannon(m_airSubsystem));
  }
